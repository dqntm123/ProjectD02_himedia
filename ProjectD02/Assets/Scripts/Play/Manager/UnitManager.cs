...
public class UnitManager : MonoBehaviour {
    ...
    public void Unit1()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[0])//gaugeMG 오브젝트의 스크립트의 변수 비프카운터가 유닛코스트 배열0번 값보다 커지거나 같아진다면
        {
            ...
            Instantiate(units[0], transform.position += new Vector3(0,Random.Range(-0.005f,0.005f), 0), transform.rotation);//units의 배열0번의 오브젝트 생성   
        }
    }
    public void Unit2()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[1])
        {
            ...
            Instantiate(units[1], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    public void Unit3()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[2])
        {
            ...
            Instantiate(units[2], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    ...
    public void Unit4()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[3])
        {
            ...
            Instantiate(units[3], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    ...
    public void Unit5()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[4])
        {
            ...
            Instantiate(units[4], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    ...
    public void Unit6()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[5])
        {
            ...
            Instantiate(units[5], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    ...
    public void Unit7()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[6])
        {
            ...
            Instantiate(units[6], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    public void Unit8()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[7])
        {
            ...
            Instantiate(units[7], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
    public void Unit9()
    {
        if (beefMG.GetComponent<BeefManager>().beefCount >= unitCost[8])
        {
            ...
            Instantiate(units[8], transform.position += new Vector3(0, Random.Range(-0.005f, 0.005f), 0), transform.rotation);
        }
    }
}
